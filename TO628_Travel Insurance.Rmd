...
#Small data size:
###Only 3,974 observations in total
#Amplified in Stacked Model:
###combined_train only has ¼ of the data in the original dataset
###Lack of representativeness leads to biases and overfitting problems
#Drawbacks of the random forest model:
###Require more work to tune the model to new data
#Limited independent variables:
###The X variables in the model may not explain all the variances in the y variable
###The model also does not account for changes in variables
```
